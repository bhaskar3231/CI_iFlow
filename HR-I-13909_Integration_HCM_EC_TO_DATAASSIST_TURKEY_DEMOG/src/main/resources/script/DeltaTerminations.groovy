...
def Message processData(Message message) {
	...
	def lastRunDateTime = pMap.get("TermlastRunDateTime");
	def CurrentDateTime = pMap.get("CurrentDateTime");
    ...
    if(lastRunDateTimeManual != ""){
        str_term.append(" and (lastModifiedDateTime ge datetime'" + lastRunDateTimeManual + "')");
        str_term.append(" and (lastModifiedDateTime lt datetime'" + CurrentDateTime + "')");
    }
    else{
        str_term.append(" and (lastModifiedDateTime ge datetime'" + lastRunDateTime + "')");
        str_term.append(" and (lastModifiedDateTime lt datetime'" + CurrentDateTime + "')");
    }
