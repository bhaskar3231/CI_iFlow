...
def String HostAddressHNS(String hostAddress){
def xmlParser = new XmlSlurper().parseText(homeAddress)
...
def String HostAddressCity(String hostAddress){
def xmlParser = new XmlSlurper().parseText(homeAddress)
...
def String HostAddressPostalCode(String hostAddress){
def xmlParser = new XmlSlurper().parseText(homeAddress)
...
def String HostAddressCountry(String hostAddress){
def xmlParser = new XmlSlurper().parseText(homeAddress)
